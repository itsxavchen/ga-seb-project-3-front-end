const BASE_URL = `${import.meta.env.VITE_EXPRESS_BACKEND_URL}/xkii`;
...
const updatePost = async function update(postId, postFormData) {
  try {
    const res = await fetch(`${BASE_URL}/${postId}`, {
      method: 'PUT',
      headers: {
...
export { index,  show, create, createComment, deletePost, updatePost, deleteComment, updateComment};